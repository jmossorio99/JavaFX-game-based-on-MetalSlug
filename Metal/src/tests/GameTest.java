...
class GameTest {
	...
	/**
	 * Prueba que el método para ordenar por nombre funciona si hay varios
	 * jugadores.
	 */
	@Test
	public void sortSeveralNamesTest() {
		...
		assertTrue(game.getPlayersList().get(game.getPlayersList().size() - 1).getName().equals("goku")); // Último
																											// elemento
																											// después
																											// de
																											// ordenar
		...
		assertTrue(game.getPlayersList().get(game.getPlayersList().size() - 1).getName().equals("123")); // Último
																											// elemento
																											// después
																											// de
																											// ordenar
	...
	public void searchMiddlePlayerTest() {
		...
		assertTrue(found.getName().equals("Jose"),
				"El jugador encontrado no tiene el mismo nombre del que se intentó buscar.");
	...
	public void searchFirstPlayerTest() {
		...
		assertNotNull(found, "No se encontro el jugador.");
		assertTrue(game.getPlayersList().get(0).equals(found),
				"El jugador encontrado no tiene el mismo nombre del que se intentó buscar.");
	...
	public void searchLastPlayerTest() {
		...
		found = game.searchPlayerName("goku");
		assertNotNull(found, "No se encontro el jugador.");
		assertTrue(game.getPlayersList().get(game.getPlayersList().size() - 1).equals(found),
				"El jugador encontrado no tiene el mismo nombre del que se intentó buscar.");
	...
	/*
	 * Prueba que la búsqueda binaria encuentra un jugador dado un puntaje que solo
	 * lo tiene ese jugador.
	 */
	@Test
	public void searchOneScorePlayerTest() {
		...
		assertTrue(playersFound.get(0).getName().equals("camilo"),
				"El nombre del jugador encontrado no coincide con el nombre del jugador con el puntaje buscado.");

		playersFound = game.searchPlayerScore(230);
		assertEquals(1, playersFound.size(), "El ArrayList debe tener un elemento.");
		assertTrue(playersFound.get(0).getName().equals("Zzz"),
				"El nombre del jugador encontrado no coincide con el nombre del jugador con el puntaje buscado.");
	}

	/**
	 * Prueba que la búsqueda binaria encuentra los jugadores que tienen el puntaje
	 * dado como parámetro.
	 */
	@Test
	...
	/**
	 * Prueba que la búsqueda binaria encuentra el o los jugadores que tienen el
	 * puntaje más bajo.
	 */
	@Test
	...
	/**
	 * Prueba que el método para eliminar un jugador es capaz de eliminar la raíz
	 * del árbol.
	 */
	@Test
	...
	/**
	 * Prueba que el método para eliminar un jugador es capaz de eliminar una hoja
	 * del árbol.
	 */
	@Test
	...
	/**
	 * Prueba que el método para eliminar es capaz de eliminar un jugador en medio
	 * del árbol.
	 */
	@Test

...
class PlayerTest extends TestCase {
	 ...
	 */
	@Test
	public void searchExistentPlayerTest() {
		setupScene2();
		assertNotNull( "No debe ser null.", player1.search(80) );
	}
	
	/**
	 * Prueba el método de buscar un jugador inexistente.
	 */
	@Test
	...
	public void deleteRootTest() {
		...
		toEliminate = player1.search(150);
		player1.deletePlayer( toEliminate );
		assertFalse( "El jugador debió haber sido eliminado.", player1.playerExists("Player1") );
	}
	...
	public void deleteMiddlePlayerTest() {
		...
		toEliminate = player1.search(103);
		player1.deletePlayer( toEliminate );
		assertFalse( "El jugador debió haber sido eliminado.", player1.playerExists("camilo") );
	}
	...
	public void deleteLeafTest() {
		...
		toEliminate = player1.search(100);
		player1.deletePlayer( toEliminate );
		assertNull( "El jugador debió haber sido eliminado.", player1 );
	}
}
